...
private:
  ...
  double jsfx_slider_next_chg (double sliderindex, double& nextval)
  {
    nextval = sliderindex == 1. ? slider1 : slider2;
    return -1.;
  }
#endif
  //----------------------------------------------------------------------------
...
public:
  ...
  {
    // Original slider line: slider1:0<-6,24,1>Gain (dB)
  ...
  {
    // Original slider line: slider1:0<-6,24,1>Gain (dB)
    return float_param ("dB", -6.0, 24.0, 0.0, 1.0);
  }
  ...
  {
    // Original slider line: slider2:0<-18,0,1>Ceiling (dB)
  ...
  {
    // Original slider line: slider2:0<-18,0,1>Ceiling (dB)
    return float_param ("dB", -18.0, 0.0, 0.0, 1.0);
  }
  ...
  {
    // Original slider line: slider3:1<0,2,1{No,Constant,Linear
    // (BETA)}>Continuous antialias mode Range: min:0.0, max:2.0, default: 1.0,
    // step: 1.0
    if (v == slider3) {
      return;
    }
  ...
  static constexpr auto get_parameter (c_alias_tag)
  {
    // Original slider line: slider3:1<0,2,1{No,Constant,Linear
    // (BETA)}>Continuous antialias mode
    return choice_param (1, make_cstr_array ("Off", "Constant", "Linear"));
  }
  ...
  {
    // Original slider line: slider4:0<0,1,1>Fix DC?
  ...
  static constexpr auto get_parameter (fix_dc_tag)
  {
    // Original slider line: slider4:0<0,1,1>Fix DC?
...
#endif
#if 0
  void set_smooth_time_slider (float v)
  {
    // Original slider line: slider5:smooth_time=50<0,100,.001>Inertia (ms)
    // Range: min:0.0, max:100.0, default: 50.0, step: 0.001
    if (v == smooth_time) {
      return;
    }
    smooth_time = v;
...
#else
  // Snippet for parameter boilerplate in the authors framework....
  struct smooth_time_tag {};

  void set (smooth_time_tag, float v)
  {
    // Original slider line: slider5:smooth_time=50<0,100,.001>Inertia (ms)
    // Range: min:0.0, max:100.0, default: 50.0, step: 0.001
    if (v == smooth_time) {
  ...
  static constexpr auto get_parameter (smooth_time_tag)
  {
    // Original slider line: slider5:smooth_time=50<0,100,.001>Inertia (ms)
    return float_param ("ms", 0.0, 100.0, 50.0, 0.001);
  }

#endif
#if 0
  void set_shelf_slider (float v)
  {
    // Original slider line: slider6:shelf=1<0,1,1>Correct for HF loss
  ...
  static constexpr auto get_parameter (shelf_tag)
  {
    // Original slider line: slider6:shelf=1<0,1,1>Correct for HF loss
...
#endif
#if 0
  void set_func_slider (float v)
  {
    // Original slider line: slider7:func=0<0,3,1{tanh,clip,sin}>Shaping
    // function Range: min:0.0, max:3.0, default: 0.0, step: 1.0
    if (v == func) {
      return;
    }
    func = v;
  ...
  static constexpr auto get_parameter (func_tag)
  {
    // Original slider line: slider7:func=0<0,3,1{tanh,clip,sin}>Shaping
    // function
    return choice_param (0, make_cstr_array ("Tanh", "Clip", "Sin"));
  }
  ...
  {
    // Original slider line: slider8:Oversampling=1<1,4,1>Oversampling
    // Range: min:1.0, max:4.0, default: 1.0, step: 1.0
    if (v == oversampling) {
      return;
    }
    oversampling = v;
...
private:
  double block;
#if 0
  double ceiling_interpolator$delta;
  double ceiling_interpolator$next_changepoint_t;
  double ceiling_interpolator$next_val;
  double ceiling_smoother$coeff;
  double ceiling_smoother$s;
#endif
  double ch0$antialias;
  double ch0$diff1;
  double ch0$diff2;
  double ch0$f0_xn;
  double ch0$f0_xnm1;
  ...
  double ch0$xnm1;
  double ch0$xnm2;
  double ch0_c$antialias;
  double ch0_c$diff;
  double ch0_c$f0_xnm1;
  double ch0_c$xnm1;
  double ch0_s$antialias;
  double ch0_s$diff;
  double ch0_s$f0_xnm1;
  double ch0_s$xnm1;
  double ch1$antialias;
  double ch1$diff1;
  double ch1$diff2;
  double ch1$f0_xn;
  double ch1$f0_xnm1;
  ...
  double ch1$xnm1;
  double ch1$xnm2;
  double ch1_c$antialias;
  double ch1_c$diff;
  double ch1_c$f0_xnm1;
  double ch1_c$xnm1;
  double ch1_s$antialias;
  double ch1_s$diff;
  double ch1_s$f0_xnm1;
  double ch1_s$xnm1;
  double current_pdc;
  ...
  double downr$idx;
#if 0
  double gain_interpolator$delta;
  double gain_interpolator$next_changepoint_t;
  double gain_interpolator$next_val;
  double gain_smoother$coeff;
  double gain_smoother$s;
#endif
  double l_delay$d0;
  double l_delay$y0;
  double l_shelf$a1;
  ...
  void init_block_variables()
  {
    block = 0;
#if 0
    ceiling_interpolator$delta              = 0;
    ceiling_interpolator$next_changepoint_t = 0;
    ceiling_interpolator$next_val           = 0;
    ceiling_smoother$coeff                  = 0;
    ceiling_smoother$s                      = 0;
#endif
    ch0$antialias   = 0;
    ch0$diff1       = 0;
    ch0$diff2       = 0;
    ...
    downr$idx       = 0;
#if 0
    gain_interpolator$delta              = 0;
    gain_interpolator$next_changepoint_t = 0;
    gain_interpolator$next_val           = 0;
    gain_smoother$coeff                  = 0;
    gain_smoother$s                      = 0;
#endif
    l_delay$d0    = 0;
    l_delay$y0    = 0;
...
private:
  void slider()
  {
    ...
    init$initialize_interpolators();
#endif
    if (eel2_eq (slider3, 2.)) {
      (target_pdc = 1. + init$getfirdelay (oversampling));
    }
    else {
      if (eel2_eq (slider3, 1.)) {
        (target_pdc = 1. + init$getfirdelay (oversampling));
      }
      else {
        if (eel2_eq (slider3, 0.)) {
          (target_pdc = init$getfirdelay (oversampling));
        }
      }
    };
  }
...
public:
  ...
  {
    double ceiling             = 0.;
    double current_ceiling     = slider2;
    double current_gain        = slider1;
    double f                   = 0.;
    double inl                 = 0.;
    double inr                 = 0.;
    double inv_ceiling         = 0.;
    double log10d20_conversion = 0.;
    double preamp              = 0.;
    double shelf_active        = 0.;

    double total_gain = 0.;

    if (eel2_ne (target_pdc, current_pdc)) {
      jsfx_specialvar_set_pdc_bot_ch (0.);
      jsfx_specialvar_set_pdc_top_ch (2.);
      jsfx_specialvar_set_pdc_delay (target_pdc);
      current_pdc = target_pdc;
    }
#if 0
    current_sample = 0.;
    init$interpolator_block (
      1.,
      gain_interpolator$next_changepoint_t,
      gain_interpolator$next_val,
      gain_interpolator$delta);
    init$interpolator_block (
      2.,
      ceiling_interpolator$next_changepoint_t,
      ceiling_interpolator$next_val,
      ceiling_interpolator$delta);
#endif

    log10d20_conversion = .11512925464970228420089957273422;
    preamp              = std::exp (log10d20_conversion * current_gain);
    ceiling             = std::exp (-log10d20_conversion * current_ceiling);
    inv_ceiling         = 1.0 / ceiling;
    total_gain          = preamp * ceiling;

    auto oversampling_cp = oversampling;
    ...
    for (uint $$i = 0; $$i < samples; ++$$i) {
...
#if 0
      current_gain = init$interpolate (
        1.,
        gain_interpolator$next_val,
        gain_interpolator$next_changepoint_t,
        gain_interpolator$delta);
      current_ceiling = init$interpolate (
        2.,
        ceiling_interpolator$next_val,
        ceiling_interpolator$next_changepoint_t,
        ceiling_interpolator$delta);
      if (smooth_time) {
        current_gain = init$smooth_parameter (
          current_gain, gain_smoother$coeff, gain_smoother$s);
        current_ceiling = init$smooth_parameter (
          current_ceiling, ceiling_smoother$coeff, ceiling_smoother$s);
      }
      ...
      spl0 *= total_gain;
      spl1 *= total_gain;
      shelf_active = shelf && eel2_eq (oversampling_cp, 1.);
      if (eel2_eq (slider3, 1.)) {
        if (shelf_active) {
          spl0 = block$s_delay (spl0, l_delay$y0, l_delay$d0);
          spl1 = block$s_delay (spl1, r_delay$y0, r_delay$d0);
        }
        else {
          spl0 = block$half_delay (spl0, l_delay$y0, l_delay$d0);
          spl1 = block$half_delay (spl1, r_delay$y0, r_delay$d0);
        }
      }
      if (eel2_eq (oversampling_cp, 1.)) {
        block$processnonlinearity (spl0, spl1);
        spl0 = outl;
        spl1 = outr;
      }
      else {
        ...
        init$updateuphist (
          ...
          upsampler$idx);
        f = 0.;
        for (int $$i2 = 0, $$end2 = std::max (0, (int) (oversampling_cp));
             $$i2 < $$end2;
             ++$$i2) {
          f += 1.;
          inl
          ...
          inr
            ...
            * init$upsample (
                ...
                upsampler$h17,
                upsampler$h16);
          block$processnonlinearity (inl, inr);
          init$updatedownhist (
            oversampling_cp,
            outl,
            downl$h65,
      ...
      if (slider4) {
        spl0 = block$fix_dc (spl0, dc0$dc_fixed, dc0$prev);
        spl1 = block$fix_dc (spl1, dc1$dc_fixed, dc1$prev);
      }
      if (eel2_ne (lastmode, slider3)) {
        (block = 6.);
      }
      if (eel2_eq (slider3, 1.) && shelf_active) {
        spl0 = block$shelf_correct (
          spl0, l_shelf$y0, l_shelf$b0, l_shelf$b1, l_shelf$d0, l_shelf$a1);
        spl1 = block$shelf_correct (
          spl1, r_shelf$y0, r_shelf$b0, r_shelf$b1, r_shelf$d0, r_shelf$a1);
      }
      if ((block > 0.)) {
        block -= 1.;
        spl0 = 0.;
...
private:
  ...
  //----------------------------------------------------------------------------
  double init$generate_shelf (double& $a1, double& $b0, double& $b1)
  {
    double theta      = 0.;
    double alpha      = 0.;
    double beta       = 0.;
    ...
    g                 = 2.20;
    f                 = 2.5;
    theta             = 1.0 - std::cos (3.141592653589793 * f);
    twodivpisq        = 2.0 / 3.141592653589793 * 3.141592653589793;
    ifcsq             = 1.0 / (f * f);
    alpha             = twodivpisq * (ifcsq + ifcsq / g) - theta;
    beta              = twodivpisq * (ifcsq + g * ifcsq) - theta;
    $a1               = -alpha / (1.0 + alpha + std::sqrt (1.0 + 2.0 * alpha));
    b                 = -beta / (1.0 + beta + std::sqrt (1.0 + 2.0 * beta));
    $b0               = (1.0 + $a1) / (1.0 + b);
    $b1               = b * $b0;
    return $b1;
  }
...
#if 0
  //----------------------------------------------------------------------------
  double init$initialize_interpolators()
  {
    init$interpolator_init (1., gain_interpolator$next_val);
    init$interpolator_init (2., ceiling_interpolator$next_val);
    new_cutoff = 1000.0 / smooth_time;
    if (eel2_ne (new_cutoff, cutoff)) {
      cutoff = new_cutoff;
      init$initialize_smoother (cutoff, gain_smoother$coeff);
      init$initialize_smoother (cutoff, ceiling_smoother$coeff);
      gain_smoother$s    = slider1;
      ceiling_smoother$s = slider2;
    }
    init$generate_shelf (l_shelf$a1, l_shelf$b0, l_shelf$b1);
    return init$generate_shelf (r_shelf$a1, r_shelf$b0, r_shelf$b1);
  }
  //----------------------------------------------------------------------------
  double init$initialize_smoother (double cutoff, double& $coeff)
  {
    double g = 0.;
    g = std::tan (3.141592653589793 * cutoff / jsfx_specialvar_get_srate());
    $coeff = g / (1. + g);
    return $coeff;
  }
  //----------------------------------------------------------------------------
  double init$interpolate (
    double  slider_idx,
    double& $next_val,
    double& $next_changepoint_t,
    double& $delta)
  {
    double current_value      = 0.;
    double next_changepoint_y = 0.;
    current_value             = $next_val;
    if (eel2_eq (current_sample, $next_changepoint_t)) {
      $delta = 0.;
      $next_changepoint_t
        = jsfx_slider_next_chg (slider_idx, next_changepoint_y);
      $delta = [&] {
        if ($next_changepoint_t > current_sample) {
          return (next_changepoint_y - current_value)
            / ($next_changepoint_t - current_sample);
        }
        else {
          return 0.;
        }
  ...
  //----------------------------------------------------------------------------
  double init$interpolator_block (
    double  slider_idx,
    double& $next_changepoint_t,
    double& $next_val,
    double& $delta)
  {
    double next_changepoint_y = 0.;
    $next_changepoint_t = jsfx_slider_next_chg (slider_idx, next_changepoint_y);
    if ($next_changepoint_t > 0.) {
      ($next_val = jsfx_slider (slider_idx));
    }
    else {
      next_changepoint_y  = jsfx_slider (slider_idx);
      $next_changepoint_t = jsfx_specialvar_get_samplesblock();
    }
    $delta = (next_changepoint_y - $next_val) / $next_changepoint_t;
    return $delta;
  }
  //----------------------------------------------------------------------------
  double init$interpolator_init (double slider_idx, double& $next_val)
  {
    $next_val = jsfx_slider (slider_idx);
    return $next_val;
  }
  //----------------------------------------------------------------------------
  double init$smooth_parameter (double target, double& $coeff, double& $s)
  {
    double v = 0.;
    double y = 0.;
    v        = $coeff * (target - $s);
...
private:
  //----------------------------------------------------------------------------
  double block$antialiased_clip_rect (
    double  x,
    double& $diff,
    double& $xnm1,
    double& $antialias,
    double& $f0_xnm1)
  {
    double eps   = 0.;
    double f0_xn = 0.;
    f0_xn        = block$f0_clip (std::abs (x));
    $diff        = (x - $xnm1);
    eps          = 0.0000000001;
    $antialias   = [&] {
      if ((std::abs ($diff) > eps)) {
        return (f0_xn - $f0_xnm1) / $diff;
      }
      else {
        return block$clip (.5 * (x + $xnm1));
      }
    }();
    $f0_xnm1 = f0_xn;
    $xnm1    = x;
  ...
  //----------------------------------------------------------------------------
  double block$antialiased_sin_rect (
    double  x,
    double& $diff,
    double& $xnm1,
    double& $antialias,
    double& $f0_xnm1)
  {
    ...
    $antialias   = [&] {
      if ((std::abs ($diff) > eps)) {
        ...
        return block$shape_sin (.5 * (x + $xnm1));
      }
    }();
    $f0_xnm1 = f0_xn;
    $xnm1    = x;
  ...
  //----------------------------------------------------------------------------
  double block$antialiased_tanh_linear (
    double  xn,
    double& $f0_xn,
    double& $f1_xn,
    double& $diff1,
    ...
    double& $f1_xnm2)
  {
    ...
    double hpi12 = 0.;
    absxn        = std::abs (xn);
    $f0_xn       = block$f0_tanh (absxn);
    hpi12        = 0.4112335167120566;
    $f1_xn       = (block$f1 (absxn) - hpi12) * jsfx_sign (xn) + hpi12;
    $diff1       = (xn - $xnm1);
    $diff2       = ($xnm2 - $xnm1);
    eps          = .2;
    $term1       = [&] {
      if ((std::abs ($diff1) > eps)) {
        $idiff = 1.0 / ($diff1 * $diff1);
        return (xn * ($f0_xn - $f0_xnm1) - ($f1_xn - $f1_xnm1)) * $idiff;
      }
      else {
        return (
          .5 * block$tanh ((xn + 2. * $xnm1) * .33333333333333333333333333333));
      }
    }();
    $term2 = [&] {
      if ((std::abs ($diff2) > eps)) {
        $idiff = 1.0 / ($diff2 * $diff2);
        return ($xnm2 * ($f0_xnm2 - $f0_xnm1) - ($f1_xnm2 - $f1_xnm1)) * $idiff;
      }
      else {
        return (
          .5
          * block$tanh (($xnm2 + 2. * $xnm1) * .33333333333333333333333333333));
      }
    }();
    $f1_xnm2 = $f1_xnm1;
    $f1_xnm1 = $f1_xn;
  ...
  //----------------------------------------------------------------------------
  double block$antialiased_tanh_rect (
    double  x,
    double& $xnm1,
    double& $antialias,
    double& $f0_xnm1)
  ...
  //----------------------------------------------------------------------------
  double block$f0_sin (double x)
  {
    return [&] {
      if (x > 1.0) {
        return x + 2.0 / 3.141592653589793 - 1.0;
      }
      else {
        return [&] {
          if (x < -1.0) {
            ...
            return -2.0 * (std::cos (0.5 * 3.141592653589793 * x) - 1.0)
              / 3.141592653589793;
          }
        }();
      }
  ...
  //----------------------------------------------------------------------------
  double block$f0_tanh (double x)
  {
    return x - std::log (2. / (1. + std::exp (-2. * x)));
  }
  //----------------------------------------------------------------------------
  double block$f1 (double x)
  {
    double em2x = 0.;
    em2x        = std::exp (-2. * x);
    return .5 * (x * (x + 2. * std::log (em2x + 1.)) - block$li2 (-em2x));
  }
  //----------------------------------------------------------------------------
  double block$fix_dc (double x, double& $dc_fixed, double& $prev)
  {
  ...
  //----------------------------------------------------------------------------
  double block$half_delay (double x, double& $y0, double& $d0)
  {
    double nu = 0.;
  ...
  double block$li2 (double x)
  {
    ...
    double pi6  = 0.;
    hf          = 0.5;
    pi3         = 3.2898681336964528729448303332921;
    pi6         = 1.644934066848226436472415166646;
    pi12        = 0.82246703342411321823620758332301;
    if (eel2_eq (x, 1.)) {
      (h = pi6);
    }
    else {
    ...
    b1   = 0.;
    b2   = 0.;
    b0   = 0.00000000000000002 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000000000000014 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00000000000000093 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000000000000610 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00000000000004042 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000000000027007 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00000000000182256 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000000001244332 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00000000008612098 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000000060578480 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00000000434545063 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000003193341274 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00000024195180854 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00000190784959387 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00001588415541880 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.00014304184442340 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.00145751084062268 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = -0.01858843665014592 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.40975987533077105 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    b0   = 0.42996693560813697 + alfa * b1 - b2;
    b2   = b1;
    b1   = b0;
    h    = -(s * (b0 - h * b2) + a);
    return h;
  ...
  //----------------------------------------------------------------------------
  double block$processnonlinearity (double inl, double inr)
  {
    return [&] {
      if (eel2_eq (func, 0.)) {
        return [&] {
          if (eel2_eq (slider3, 2.)) {
            outl = block$antialiased_tanh_linear (
              inl,
              ch0$f0_xn,
              ch0$f1_xn,
              ch0$diff1,
              ...
              ch0$f0_xnm2,
              ch0$f1_xnm2);
            outr = block$antialiased_tanh_linear (
              inr,
              ch1$f0_xn,
              ch1$f1_xn,
              ch1$diff1,
            ...
            return [&] {
              if (eel2_eq (slider3, 1.)) {
                outl = block$antialiased_tanh_rect (
                  inl, ch0$xnm1, ch0$antialias, ch0$f0_xnm1);
                outr = block$antialiased_tanh_rect (
                  inr, ch1$xnm1, ch1$antialias, ch1$f0_xnm1);
                return outr;
              }
              else {
                outl = block$tanh (inl);
          ...
          if (eel2_eq (func, 1.)) {
            return [&] {
              if (eel2_eq (slider3, 0.)) {
                ...
                outl = block$antialiased_clip_rect (
                  inl, ch0_c$diff, ch0_c$xnm1, ch0_c$antialias, ch0_c$f0_xnm1);
                outr = block$antialiased_clip_rect (
                  inr, ch1_c$diff, ch1_c$xnm1, ch1_c$antialias, ch1_c$f0_xnm1);
                return outr;
              }
            }();
          }
            ...
            return [&] {
              if (eel2_eq (func, 2.)) {
                return [&] {
                  if (eel2_eq (slider3, 0.)) {
                    outl = block$shape_sin (inl);
                    outr = block$shape_sin (inr);
                    return outr;
                  }
                  else {
                    outl = block$antialiased_sin_rect (
                      inl,
                      ch0_s$diff,
                      ch0_s$xnm1,
                      ch0_s$antialias,
                      ch0_s$f0_xnm1);
                    outr = block$antialiased_sin_rect (
                      inr,
                      ch1_s$diff,
                      ch1_s$xnm1,
                      ch1_s$antialias,
  ...
  //----------------------------------------------------------------------------
  double block$s_delay (double x, double& $y0, double& $d0)
  {
    double nu = 0.;
    nu        = 0.036;
    $y0       = nu * x + $d0 - nu * $y0;
  ...
  //----------------------------------------------------------------------------
  double block$shape_sin (double x)
  {
    return [&] {
      if (x > 1.0) {
        return 1.0;
        ...
        return [&] {
          if (x < -1.0) {
            ...
            return std::sin (.5 * 3.141592653589793 * x);
          }
        }();
      }
    }();
