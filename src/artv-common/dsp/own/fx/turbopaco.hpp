...
private:
  ...
  using algorithms_type = std::variant<
    ...
    detail::tpaco::ping_pong_a<dt_fix16>,
    detail::tpaco::ping_pong_a<dt_flt16>,
    detail::tpaco::ping_pong_a<dt_flt32>,
    detail::tpaco::ping_pong_b<dt_fix16>,
    detail::tpaco::ping_pong_b<dt_flt16>,
    detail::tpaco::ping_pong_b<dt_flt32>,
