...
template <class V>
struct vec_complex {
  static_assert (is_floatpt_vec_v<V>, "V must be a vector type.");
  //----------------------------------------------------------------------------
...
template <class C, enable_if_complex_vec_t<C>* = nullptr>
static inline C vec_load (xspan<complex_float_type_t<C> const> src)
{
...
template <class C, enable_if_complex_vec_t<C>* = nullptr>
static inline void vec_load (C& dst, xspan<complex_float_type_t<C> const> src)
{
  dst = vec_load<C> (src);
}
...
template <class C, enable_if_complex_vec_t<C>* = nullptr>
static inline C vec_load (xspan<complex_value_type_t<C> const> src)
{
  assert (src.size() >= C::size);
  return vec_load<C> (src.data());
}
...
template <class C, enable_if_complex_vec_t<C>* = nullptr>
static inline void vec_load (C& dst, xspan<complex_value_type_t<C> const> src)
{
  dst = vec_load<C> (src);
}
...
template <class C, enable_if_complex_vec_t<C>* = nullptr>
static inline C vec_load_unaligned (xspan<complex_float_type_t<C> const> src)
{
  assert (src.size() >= C::size);
...
static inline void vec_load_unaligned (
  C&                                   dst,
  xspan<complex_float_type_t<C> const> src)
{
  dst = vec_load_unaligned<C> (src);
}
...
template <class C, enable_if_complex_vec_t<C>* = nullptr>
static inline C vec_load_unaligned (xspan<complex_value_type_t<C> const> src)
{
  assert (src.size() >= C::size);
  return vec_load_unaligned<C> (src.data());
}
...
static inline void vec_load_unaligned (
  C&                                   dst,
  xspan<complex_value_type_t<C> const> src)
{
  dst = vec_load_unaligned<C> (src);
}
//------------------------------------------------------------------------------
